...
public class MapleFarm {
    ...
    private MapleFarm(int id, ClientSocket owner, String name) {
        this.id = id;
        this.owner = owner;
        this.name = name;
    }

    public static MapleFarm getDefault(int id, ClientSocket owner, String name) {
    ...
    public void setOwner(ClientSocket owner) {
        this.owner = owner;
    }
