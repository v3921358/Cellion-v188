...
function setup(eim, leaderid) {
    ...
    var map = fac.getMap(980032000); // Start Map
    map.resetMap();
    map = fac.getMap(980032100); // Main
    map.resetMap();
    map = fac.getMap(980032200); // Revive
    map.resetMap();
    ...
    eim.setPropertyEx("MainMap",980032100);
...
function playerEntry(eim, player) {
    var map = em.getMapFactory().getMap(980032000);
