...
function setup(eim, leaderid) {
    ...
    var eim = em.newInstance("Carnival2_Room3");

    var fac = em.getMapFactory();
    var map = fac.getMap(980033000); // Start Map
    map.resetMap();
    map = fac.getMap(980033100); // Main
    map.resetMap();
    map = fac.getMap(980033200); // Revive
    map.resetMap();
    ...
    eim.setPropertyEx("MainMap",980033100);
...
function playerEntry(eim, player) {
    var map = em.getMapFactory().getMap(980033000);
