...
function setup() {
    ...
    var eim = em.newInstance("zakjq");

    eim.setProperty("allow_warpback", "false");
    eim.setPropertyEx("WinOrder", 1);

    var map = eim.createInstanceMapS(280020000, 910000000, "zakjq");

    eim.schedule("CloseWarp", 1100000);
    eim.startEventTimer(2200000);

    em.broadcastWorldMsg(6, "[Event] Zakum jump quest event has started! Please use @zakjq to get into the event at channel 1!");
