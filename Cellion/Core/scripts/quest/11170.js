/*
	...
	Description: 		Quest - Elite Warrior Blessing
*/
...
function start(mode, type, selection) {
    ...
    if (status == 0) {
	qm.sendNext("Hello, #h0#. Have you heard about this big changes to warrior recently? Well, we decided to give a little something special to those players who stuck with their warrior even through tough times. Would you like this gift?");
    } else if (status == 1) {
	books = [2290285, 2290294, 2290295, 2290296, 2290297, 2290298, 2290299, 2290300, 2290301, 2290302];
