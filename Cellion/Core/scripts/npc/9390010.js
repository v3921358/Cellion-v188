...
function start() {
	...
	cm.sendOk("You know, you can get one of these awesome accessories by fighting the aliens in the spaceship\r\n#i1113038# #bAlien Fragment Ring#k\r\n#i1122256# #bAlien Fragment Necklace#k\r\n#i1032191# #bAlien Fragment Earring#k\r\n#i1113038# #bAlien Fragment Belt#k\r\nThere is rumor that helmet can only be taken from #r'Mysterious Visitor'#k  Interesting. Is it not?\r\n#i1003893# #bRare Alien Fragment Helmet#k");
	cm.dispose();
	return;
}
