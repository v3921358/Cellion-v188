				...
				if (cm.getPlayer().getJob() > 508 && cm.getPlayer().getJob() != 2210 && cm.getPlayer().getJob() != 3101) {
					...
					switch(cm.getPlayer().getJob()){
						...
						case 100:cm.sendSimple("You are currently a #bWarrior#k.\r\n"
							...
							break;
						//Magician
						case 200:cm.sendSimple("You are currently a #Magician#k.\r\n"
							+ "Please choose your job advancement.\r\n"
							...
							break;
						//Archer
						case 300:cm.sendSimple("You are currently an #Archer#k.\r\n"
							+ "Please choose your job advancement.\r\n"
							+ "#r#L1#Hunter#l\r\n"
							+ "#r#L2#Crossbowman#l\r\n");
							break;
						//Thief
						case 400:cm.sendSimple("You are currently a #Thief#k.\r\n"
							+ "Please choose your job advancement.\r\n"
							+ "#r#L1#Assassin#l\r\n"
							+ "#r#L2#Bandit#l\r\n");
							break;
						//Pirate
						case 500:cm.sendSimple("You are currently a #Pirate#k.\r\n"
							+ "Please choose your job advancement.\r\n"
							+ "#r#L1#Brawler#l\r\n"
							+ "#r#L2#Gunslinger#l\r\n");
							break;
