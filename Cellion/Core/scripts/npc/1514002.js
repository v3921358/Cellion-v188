...
function start() {
	...
	cm.sendSimple("#e#r[Welcome to AstralNetwork Exclusive SAO World Expedition]#l\r\n#rAre you the chosen one to fight towards your virtual reality and to destroy the game itself?#l");
}
