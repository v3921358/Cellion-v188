...
function action(mode, type, selection){
	...
	if (status == 0){
		if (!cm.getPlayer().getInventory(1).isFull()) {
	...
	//Message that appears when the user chooses an option. List all the items in the category. User chooses the item
		...
		switch(selection){
			...
			//Onyx Equipment
			case 2:
				textBox = "Onyx Equipment cost #b7500#k #i4001126##t4001126# and #b8,000,000 mesos#k.\r\nWhat would you like to craft?\r\n";
			...
			//Onyx Weapon
			case 3:
				textBox = "Onyx Weapon cost #b7500#k #i4001126##t4001126# and #b8,000,000 mesos#k.\r\nWhat would you like to craft?\r\n";
		...
		if (selection >= 0 && selection < 200){
			if (cm.haveItem(4001126, 2000) && (cm.getMeso() >= 2000000)){
		...
		//Onyx Equipment & Weapon
			...
			if (cm.haveItem(4001126, 7500) && (cm.getMeso() >= 8000000)){
				if (selection < 300){
