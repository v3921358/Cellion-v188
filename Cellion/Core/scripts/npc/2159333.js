...
function start() {
    if (cm.getPlayer().getLevel() < 160) {
        cm.sendOk("There is a level requirement of 160 to attempt Pink Bean.");
        cm.dispose();
        return;
    }
    ...
    var em = cm.getEventManager("ChaosPinkBeanBattle");
    ...
    if (eim_status == null || eim_status.equals("0")) {
        ...
        if (squadAvailability == -1) {
            ...
            var eim = cm.getDisconnected("ChaosPinkBeanBattle");
            if (eim == null) {
...
function action(mode, type, selection) {
    switch (status) {
        case 0:
            ...
            break;
        case 2:
            if (!cm.reAdd("ChaosPinkBeanBattle", "PinkBean")) {
            ...
            if (mode == 1) {
                if (selection == 0) {
                    ...
                    if (cm.getSquad("PinkBean") != null) {
                        var dd = cm.getEventManager("ChaosPinkBeanBattle");
