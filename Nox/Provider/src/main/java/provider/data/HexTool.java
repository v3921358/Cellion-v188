...
public class HexTool {
    ...
    private static String getLeftPaddedStr(final String in, final char padchar, final int length) {
    ...
    public static String getOpcodeToString(final int op) {
        return "0x" + getLeftPaddedStr(Integer.toHexString(op).toUpperCase(), '0', 4);
    }
}
