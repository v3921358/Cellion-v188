...
public class MapScriptManager extends AbstractScriptManager {
    ...
    public static boolean executeMapScript(final MapleClient c, String scriptName, boolean isFirstUserEnter, int LastMapId) {
    ...
    public static boolean executeMapScript_FieldSet(final MapleClient c, String scriptName, int LastMapId) {
