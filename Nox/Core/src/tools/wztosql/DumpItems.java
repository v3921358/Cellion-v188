...
public class DumpItems {
    ...
    private final MapleDataProvider item, string, character;
    ...
    public void dumpItem(PreparedStatement psa, PreparedStatement psr, PreparedStatement ps, PreparedStatement pse, MapleData iz) throws Exception {
        ...
        try {
            ...
            if (dat != null) {
                ps.setInt(19, MapleDataTool.getIntConvert("itemid", dat, 0));
                ps.setString(20, MapleDataTool.getString("msg", dat, ""));
            } else {
                ps.setInt(19, 0);
                ps.setString(20, "");
            }
            ps.setInt(21, MapleDataTool.getIntConvert("info/create", iz, 0));
            ps.addBatch();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    protected final MapleData getStringData(final int itemId) {
        ...
        if (itemId >= 5010000) {
        ...
        } else if ((itemId >= 1132000 && itemId < 1195000) || (itemId >= 1010000 && itemId < 1040000) || (itemId >= 1122000 && itemId < 1125000)) {
            data = eqpStringData;
            cat = "Eqp/Accessory";
            ...
            data = eqpStringData;
            cat = "Eqp/Coat";
        } else if (itemId >= 20000 && itemId < 28000) {
            data = eqpStringData;
            cat = "Eqp/Face";
        } else if (itemId >= 1080000 && itemId < 1090000) {
            data = eqpStringData;
            cat = "Eqp/Glove";
        } else if (itemId >= 30000 && itemId < 45000) {
            data = eqpStringData;
            cat = "Eqp/Hair";
            ...
            data = eqpStringData;
            cat = "Eqp/Ring";
        } else if (itemId >= 1092000 && itemId < 1099999) {
            data = eqpStringData;
            cat = "Eqp/Shield";
        } else if (itemId >= 1070000 && itemId < 1080000) {
            data = eqpStringData;
            cat = "Eqp/Shoes";
        } else if (itemId >= 1900000 && itemId < 1999999) {
            data = eqpStringData;
            cat = "Eqp/Taming";
