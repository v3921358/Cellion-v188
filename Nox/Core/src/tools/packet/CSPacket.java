...
//        for (CashItem i : cif.getMenuItems(301)) {//TODO create and load form favorites?
    ...
    public static OutPacket warpCS(ClientSocket c) {
    ...
    public static OutPacket getCSInventory(ClientSocket c) {
    ...
    public static OutPacket getCSGifts(ClientSocket c) {
...
//        }
    ...
    public static OutPacket showCouponRedeemedItem(Map<Integer, Item> items, int mesos, int maplePoints, ClientSocket c) {
    ...
    public static OutPacket showCouponGifted(Map<Integer, Item> items, String receiver, ClientSocket c) {
