...
public enum ApiErrorCode implements ApiReturnCode {
    ...
    */
    ...
    INVALID_USER_CREDENTIALS(102, "Your Lumiere ID or password is invalid. Please try again."),
    ...
    ACCOUNT_BLOCKED_BY_ADMIN(110, "Your account has been blocked by an administrator. Please visit our Customer Support center at https://support.lumiere.network and submit a ticket."),
    ...
    ACCOUNT_BLOCKED_BY_ADMIN_FRAUD(112, "Your account has been blocked by an administrator for fraudulent Lumiere Point purchases and/or charges. These blocks are final and cannot be reversed."),
    ACCOUNT_BLOCKED_BY_ADMIN_SUSPICIOUS(113, "Your account has been blocked by an administrator for suspicious activity. Please visit our Customer Support center at https://support.lumiere.network to undergo a reverification process."),
    ACCOUNT_BLOCKED_BY_SYSTEM(114, "Your account has been blocked. Please visit our Customer Support center at https://support.lumiere.network and submit a ticket."),
    ACCOUNT_BLOCKED_BY_SYSTEM_IRREVERSIBLE(115, "Your account has been blocked. This block is final and cannot be reversed."),
    ACCOUNT_BLOCKED_BY_SYSTEM_FRAUD(116, "Your account has been blocked for fraudulent Lumiere Point purchases and/or charges. Please visit our Customer Support center at https://support.lumiere.network and submit a ticket."),
    ACCOUNT_BLOCKED_BY_SYSTEM_SUSPICIOUS(117, "Your account has been for suspicious activity. Please visit our Customer Support center at https://support.lumiere.network to undergo a reverification process."),
