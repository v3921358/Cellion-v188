...
public class Token {
	...
	*/
	...
	/**
	 * The refresh token is sent to the API to get a new auth token before the
	 * current one expires. 
	...
	/**
	 * If an error occurred, this will return the error type. If no error occurred
	 * it will be null.
	...
	/**
	 * Returns true if the request was successful and an access token was 
	 * obtained. If not check the return from {@link getError()} to find out 
	 * what went wrong.
	 * @return 
	 */
	...
	/**
	 * Used to set if the request succeeded or not. This should be set after the
	 * API returns.
