...
public enum MapleStat {
    ...
    FAME(0x20000), // int
    MESO(0x40000), // long
    //PET(0x180008), // Pets: 0x8 + 0x80000 + 0x100000  [3 longs] (Outdated Flag, no longer used)
    ...
    CHARM(0x2000000), // int
    TRAIT_LIMIT(0x4000000), // 12 bytes (21 in 170?)
    ALBA_ACTIVITY(0x8000000),
    CHARACTER_CARD_UPDATE(0x10000000),
    BATTLE_EXP(0x20000000), // byte, int, int
    BATTLE_RANK(0x40000000), // byte
    BATTLE_POINTS(0x80000000),
    ICE_GAUGE(0x200000000L),
    VIRTUE(0x400000000L);
