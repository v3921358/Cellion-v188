...
function setup(eim, leaderid) {
    ...
    var eim = em.newInstance("Carnival2_Room1");

    var fac = em.getMapFactory();
    var map = fac.getMap(980031000); // Start Map
    map.resetMap();
    map = fac.getMap(980031100); // Main
    map.resetMap();
    map = fac.getMap(980031200); // Revive
    map.resetMap();
    ...
    eim.setPropertyEx("MainMap",980031100);
...
function playerEntry(eim, player) {
    var map = em.getMapFactory().getMap(980031000);
