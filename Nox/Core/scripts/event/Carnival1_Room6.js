...
function setup(eim, leaderid) {
    ...
    var eim = em.newInstance("Carnival1_Room6");

    var fac = em.getMapFactory();
    var map = fac.getMap(980000600); // Start Map
    map.resetMap();
    map = fac.getMap(980000601); // Main
    map.resetMap();
    map = fac.getMap(980000602); // Revive
    map.resetMap();
    ...
    eim.setPropertyEx("MainMap",980000601);
...
function playerEntry(eim, player) {
    var map = em.getMapFactory().getMap(980000600);
