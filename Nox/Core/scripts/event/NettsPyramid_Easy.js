...
function setup(eim, leaderid) {
	...
	if (em.getProperty("res" + i).equals("0")) {
	    var available = em.getMapFactory().getMap(926010100 + i);
...
function playerEntry(eim, player) {
	...
	var available = em.getMapFactory().getMap(926010100 + eim.getPropertyEx("Selected"));
	if (available == null) {
	    eim.unregisterPlayer(player);
