...
var pvpName = "PVP_Solo_GM";
var basemapid = 960010100;
var pvpid = 0;
var maxPlayer = 100;
var reqPlayer = 4;
var pvpLvlmode = 3;
var pvpType = 0; // 0 = Solo, 1 = Party, 2 = Iceknight, 3 = Capture
...
function setup(name) {
    ...
    pvpid = basemapid + Math.floor(Math.random() * 2);
    
    em.broadcastWorldMsg(6, "[Event] GM PVP event has started! Please use @pvp command to access it at Channel 1!");
...
function startPvp(eim) {
    eim.broadcastPvpMapEffect("SOLO_START");
...
function changedMap(eim, player, mapid) {
    ...
    if (mapid >= 960010100 && mapid <= 960010102) {
	return;
    }
