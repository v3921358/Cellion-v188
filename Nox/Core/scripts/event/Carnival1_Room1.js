...
function setup(eim, leaderid) {
    ...
    var eim = em.newInstance("Carnival1_Room1");

    var fac = em.getMapFactory();
    var map = fac.getMap(980000100); // Start Map
    map.resetMap();
    map = fac.getMap(980000101); // Main
    map.resetMap();
    map = fac.getMap(980000102); // Revive
    map.resetMap();
    ...
    eim.setPropertyEx("MainMap",980000101);
...
function playerEntry(eim, player) {
    var map = em.getMapFactory().getMap(980000100);
