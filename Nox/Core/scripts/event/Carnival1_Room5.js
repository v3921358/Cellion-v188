...
function setup(eim, leaderid) {
    ...
    var eim = em.newInstance("Carnival1_Room5");

    var fac = em.getMapFactory();
    var map = fac.getMap(980000500); // Start Map
    map.resetMap();
    map = fac.getMap(980000501); // Main
    map.resetMap();
    map = fac.getMap(980000502); // Revive
    map.resetMap();
    ...
    eim.setPropertyEx("MainMap",980000501);
...
function playerEntry(eim, player) {
    var map = em.getMapFactory().getMap(980000500);
