...
function setup(eim, leaderid) {
    ...
    var eim = em.newInstance("Carnival1_Room3");

    var fac = em.getMapFactory();
    var map = fac.getMap(980000300); // Start Map
    map.resetMap();
    map = fac.getMap(980000301); // Main
    map.resetMap();
    map = fac.getMap(980000302); // Revive
    map.resetMap();
    // 980000103 = Victory
    // 980000103 = Lose
    // 
    ...
    eim.setPropertyEx("MainMap",980000301);
...
function playerEntry(eim, player) {
    var map = em.getMapFactory().getMap(980000300);
...
function scheduledTimeout(eim) {
	...
	case 3:
	    ...
	    eim.warpAllPlayer_Carnival(980000301);
