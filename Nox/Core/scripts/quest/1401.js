...
function end(mode, type, selection) {
    ...
    if (status == 0) {//Start Up
		qm.sendYesNo("The Warrior is a solid, well-rounded character perfect for players new to MapleStory. This character excels at defense, with large amounts of health and access to powerful suits of armor.\r\n\r\nSo, do you want to become a Warrior?\r\nThis decision will be final, so think carefully.");
    } else if (status == 1) { //Quiz Intro
		qm.sendAcceptDecline("Before I turn you into a Warrior, you're going to need to prove yourself. Answer every question of the #dREXION Quiz#k correctly and then I'll help you.");
		...
		qm.sendOk("When Explorer-type Warriors reach a certain level, they can choose between three different specializations: Fighter, Page or Spearman. They can continue to level and grow, to ultimately become a Hero, Paladin or Dark Knight.\r\nHave fun on your adventure!");
