...
function end(mode, type, selection) {
    ...
    if (status == 0) {//Start Up
		qm.sendYesNo("Night Walkers are Cygnus Knights that serve... well... the night, obviously. These devious tricksters are lucky and dexterous and have mastered the art of the throwing star.\r\n\r\nSo, do you want to become a Night Walker?\r\nThis decision will be final, so think carefully.");
    } else if (status == 1) { //Quiz Intro
		qm.sendAcceptDecline("Before I turn you into a Night Walker, you're going to need to prove yourself. Answer every question of the #dREXION Quiz#k correctly and then I'll help you.");
		...
		qm.sendOk("These sneaky rogues can use poison to stop enemies dead in their tracks. Emo? Maybe. But never underestimate a Night Walker. When the sun sets, you'll never see them coming.");
