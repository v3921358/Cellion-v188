...
function end(mode, type, selection) {
    ...
    if (status == 0) {//Start Up
		qm.sendYesNo("A soldier of truth, a light in the darkness, the Dawn Warrior is a strong swordsman with unparalleled skill. Loyal to Empress Cygnus, the Dawn Warrior is protected by Sol, the spirit of light. \r\n\r\nSo, do you want to become a Dawn Warrior?\r\nThis decision will be final, so think carefully.");
    } else if (status == 1) { //Quiz Intro
		qm.sendAcceptDecline("Before I turn you into a Dawn Warrior, you're going to need to prove yourself. Answer every question of the #dREXION Quiz#k correctly and then I'll help you.");
		...
		qm.sendOk("The Dawn warrior channels the powers of the sun and the moon into strong attacks and has high defense. With a variety of combos and skills, each with varying effects, Dawn Warriors are perfect for players looking for a more strategic challenge.");
