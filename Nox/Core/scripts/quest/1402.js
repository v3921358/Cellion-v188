...
function end(mode, type, selection) {
    ...
    if (status == 0) {//Start Up
		qm.sendYesNo("The Magician may look fragile, but this powerful magic-user can obliterate enemies from afar with devastating spells. With a large amount of mana, the Magician can cast elemental or supportive skills from a distance while characters stronger in melee combat engage monsters up close.\r\n\r\nSo, do you want to become a Magician?\r\nThis decision will be final, so think carefully.");
    } else if (status == 1) { //Quiz Intro
		qm.sendAcceptDecline("Before I turn you into a Magician, you're going to need to prove yourself. Answer every question of the #dREXION Quiz#k correctly and then I'll help you.");
		...
		qm.sendOk("When Explorer-type Magicians reach a certain level, they can choose between three different specializations: Fire and Poison Arch Mage, Lightning Arch Mage or Bishop.");
