...
function end(mode, type, selection) {
    ...
    if (status == 0) {//Start Up
		qm.sendYesNo("Like the rest of the Cygnus Knights, Wind Archers share a bond with a specific elemental spirit, in this case Storm, the Spirit of Wind. Protectors of nature and all living things, Wind Archers can harness the power of wind to send their enemies spiraling.\r\n\r\nSo, do you want to become a Wind Archer?\r\nThis decision will be final, so think carefully.");
    } else if (status == 1) { //Quiz Intro
		qm.sendAcceptDecline("Before I turn you into a Wind Archer, you're going to need to prove yourself. Answer every question of the #dREXION Quiz#k correctly and then I'll help you.");
		...
		qm.sendOk("Like Explorer Bowmen, Wind Archers are most useful at long distances, but they also have their own unique abilities to help them control the field of battle.");
