...
function end(mode, type, selection) {
    ...
    if (status == 0) {//Start Up
		qm.sendYesNo("Bowmen are nimble, long-range snipers. They have a variety of skills to help attack, evade danger, buff their damage, and launch arrows at groups of monsters.\r\n\r\nSo, do you want to become a Bowman?\r\nThis decision will be final, so think carefully.");
    } else if (status == 1) { //Quiz Intro
		qm.sendAcceptDecline("Before I turn you into a Bowman, you're going to need to prove yourself. Answer every question of the #dREXION Quiz#k correctly and then I'll help you.");
		...
		qm.sendOk("When Explorer-type Bowmen reach a certain level, they can choose between two different specializations: Bowmaster or Marksman.");
