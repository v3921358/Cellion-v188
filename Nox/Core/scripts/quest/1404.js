...
function end(mode, type, selection) {
    ...
    if (status == 0) {//Start Up
		qm.sendYesNo("Thieves are born sneaks. They're skilled at dodging attacks and are particularly fond of stealth, using their abilities to evade enemies or hide from them entirely.\r\n\r\nSo, do you want to become a Thief?\r\nThis decision will be final, so think carefully.");
    } else if (status == 1) { //Quiz Intro
		qm.sendAcceptDecline("Before I turn you into a Thief, you're going to need to prove yourself. Answer every question of the #dREXION Quiz#k correctly and then I'll help you.");
		...
		qm.sendOk("When Explorer-type Thieves reach a certain level, they can choose between two different specializations: Night Lord or Shadower.");
