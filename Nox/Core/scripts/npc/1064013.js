	...
	if (mode != 1) {
		...
		if (status == 0) {
			var sendString = "Welcome #h #, to the #bColossal Root#k.\r\n"
							+ "Von Bon is one of the four main bosses of Root Abyss, working for Damien to restrict the World Tree's power.\r\n"
							+ "\r\n\r\n \t\t\t\t\t\t\t\t\t\t #v03994116# \r\n#r#L0#(Solo Boss Fight) #dFace off against Von Bon alone!#l#k\r\n"
			...
			switch(selection) {
				...
				case 1: // Party Fight
					if (cm.getPlayerCount(105200120) == 0) {
						...
						cm.sendOk("Sorry, looks like another expedition squad is currently fighting Von Bon on this channel. You will be able to enter once they are finished.");
						cm.dispose();
					}
					break;
				case 2: // Chaos - Solo
