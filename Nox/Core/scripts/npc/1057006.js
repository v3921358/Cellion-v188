    ...
    if (status == 0) {
        if (cm.getPlayer().getVMatrixRequirement() && cm.getPlayer().nMobKillsV < 1) {
            ...
            cm.sendOk("I see you still haven't completed my tasks, don't waste my time.\r\n\r\n"
					+ "\t#rKill Lv. 200+ Monsters#k (" + cm.getPlayer().nMobKillsV + "#k / " + "#b1000#k)\r\n"
					+ "\t#rKill Magnus#k (#b" + cm.getPlayer().nMagnusKillsV + "#k / " + "#b1#k)\r\n"
					+ "\t#rKill Vellum#k (#b" + cm.getPlayer().nVellumKillsV + "#k / " + "#b1#k)\r\n"
					+ "\t#rKill the Crimson Queen#k (#b" + cm.getPlayer().nCrimsonQueenKillsV + "#k / " + "#b1#k)\r\n"
					+ "\t#rKill Von Bon#k (#b" + cm.getPlayer().nVonBonKillsV + "#k / " + "#b1#k)\r\n"
					+ "\t#rKill Pierre#k (#b" + cm.getPlayer().nPierreKillsV + "#k / " + "#b1#k)\r\n");
            cm.dispose();
