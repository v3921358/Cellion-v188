...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		cm.sendDirectionStatus(1, 1000);
		cm.showReservedEffect_CutScene("Effect/Direction4.img/effect/cannonshooter/face02");
		...
		cm.sendDirectionStatus(1, 1000);
		cm.showReservedEffect_CutScene("Effect/Direction4.img/effect/cannonshooter/face05");
		...
		cm.showReservedEffect_CutScene("Effect/Direction4.img/effect/cannonshooter/face01");
		cm.sendDirectionStatus(1, 1000);
		cm.sendDirectionStatus(3, 2);
