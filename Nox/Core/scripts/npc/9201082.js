...
var craftOptions = ["Lv. 30 Pearl Equipment and Accessories", "Lv. 30 Pearl Weapon", "Lv. 100 Onyx Equipment and Accessories", "Lv. 100 Onyx Weapon", "Lv. 100 Onyx Ring\r\n", "Lv. 150 Fafnir Equipment", "Lv. 150 Fafnir Weapon", "Lv. 150 Tyrant Equipment\r\n", "Miscellanious Items"];
...
/*function start() {
    cm.sendNext("Welcome to the #dCELLION#k Blacksmith Workshop!\r\nWhere you can craft all of the strongest gear.");
	status = -1;
}*/
...
function action(mode, type, selection){
	...
	if (status == 0){
		textBox = "Welcome to the #dCELLION#k Blacksmith Service!\r\n"
